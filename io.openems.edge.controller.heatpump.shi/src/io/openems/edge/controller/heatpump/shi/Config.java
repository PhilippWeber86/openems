...
@interface Config {
	...
	@AttributeDefinition(name = "Run extension minimum temperature delta", description = "A natural run is only extended if the elevated hot-water setpoint exceeds the heat pump's own setpoint by at least this delta in 0.1 K (default 30 = 3 K). Prevents tiny extensions whose benefit is eaten by standing losses.")
	int extensionMinTemperatureDelta() default 30;
