...
public class MyConfig extends AbstractComponentConfig implements Config {
	...
	protected static class Builder {
		...
		private double forecastChargeCRate = 0.5;
		...
		public Builder setForecastChargeCRate(double value) {
			this.forecastChargeCRate = value;
			return this;
		}
	...
	@Override
	public double forecastChargeCRate() {
		return this.builder.forecastChargeCRate;
	}
